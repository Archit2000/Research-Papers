...
for alpha_param in [1,0.1,0.01,0.001,0.0001]:
    for beta_param in [100,10,1,0.1,0.01,0.001,0.0001]:
        for gamma_param in [100,10,1,0.1,0.01,0.001,0.0001]:
            for lambda_param in [100,10,1,0.1,0.01,0.001,0.0001]:
                for delta_param in [100,10,1,0.1,0.01,0.001,0.0001]:
                    try:
